...
echo "🚀 Secure_Project_20250913_203402 のデプロイを開始します..."
echo "--------------------------------------------------"

# --- 変数設定 (環境に合わせて変更してください) ---
GCP_PROJECT_ID="your-gcp-project-id"
GCP_REGION="asia-northeast1"
FRONTEND_SERVICE_NAME="secure-project-20250913-203402-frontend"
BACKEND_SERVICE_NAME="secure-project-20250913-203402-backend"
